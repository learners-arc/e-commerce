...
const BasketPage = () => {
    ...
    if(groupedItems.length === 0) {
        return <div className="container mx-auton p-4 flex flex-col items-center justify-center min-h-[50vh]">
    ...
    return (
    <div className="container ax-autp p-4 max-w-6xl">
            ...
            <div className="flex-grow">
                {
                    groupedItems?.map((item) => (
                        ...
                        className="mb-4 p-4 flex items-center justify-between border rounded">
